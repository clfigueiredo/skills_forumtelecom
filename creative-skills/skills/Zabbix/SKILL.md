---
name: zabbix
description: "Cria criativos estaticos promocionais para o curso Zabbix 7 + Grafana da Forum Telecom, com foco em conversao, variacao de paletas e estilos visuais. Use quando o usuario pedir criativos, posts, artes, imagens promocionais, stories, anuncios ou material de divulgacao para o curso Zabbix. Em vez de entregar apenas prompts, esta skill deve analisar os criativos de referencia fornecidos, sintetizar os prompts internamente e gerar as imagens diretamente. O comportamento padrao deve gerar 12 criativos no total: 6 em 1080x1350 e 6 em 1080x1920, sempre como artes completas sem area reservada para video, com estilos, paletas e densidades de informacao variadas."
---
...
Gerar imagens promocionais estaticas completas para o curso Zabbix 7 + Grafana da Forum Telecom com base nas referencias visuais do usuario e nas informacoes padrao do curso em `references/curso-info.md`.
...
- distribuir texto, produto visual, dashboards e elementos tecnicos de forma integrada
...
- Preservar o nome da marca `Forum Telecom` e o nome do curso `Zabbix 7 + Grafana`.
...
- Informar elementos visuais recorrentes: Zabbix, Grafana, dashboards, alertas, notificacoes, Linux, SNMP, ZeroTier, WhatsApp, Telegram, servidores, NOC, telas de monitoramento, glow UI, grids, graficos e elementos de observabilidade.
...
- nivel de preenchimento visual da composicao
- preco e oferta
